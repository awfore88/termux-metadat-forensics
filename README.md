...
This wasn't just a copy-paste job. I used Claude to help me understand the "under the hood" logic of how files store data, and then I wrote the code and commented it out to make sure I actually knew what was happening with every byte.
...
*  GPS Mapping: Follows nested "hex pointers" (like 0x8825) to find hidden GPS data, converts it to decimal degrees, and generates a Google Maps link.
